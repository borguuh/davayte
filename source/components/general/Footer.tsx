...
const Footer = () => {
  ...
  return (
    <footer className="bg-otherBg text-lightText px-6 md:px-12 xl:px-20 w-full mt-32 pt-16 pb-10 flex justify-between flex-wrap flex-col md:flex-row">
      <div className="flex flex-col text-center md:text-left font-playfair gap-6">
        <h1 className="italic text-3xl font-medium flex items-center md:self-start self-center">Davayte</h1>
      ...
      <div className="flex flex-col gap-[8px] text-center w-full pt-12 text-sm">
        ...
        <span className="uppercase">© {new Date().getFullYear()} Davayte. All rights reserved.</span>
      </div>
    </footer>
  )
}
